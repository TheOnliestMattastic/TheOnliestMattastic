...
- **📊 Tobacco & Vital Signs Research (R, ggplot2, R Markdown)** — Statistical analysis showing ability to translate raw data into reproducible insights. Clear communication for technical and non-technical audiences.  
- **🪐 The Onliest Folio (HTML, CSS, JavaScript)** — Dual-purpose personal portfolio and beginner-friendly template. Shows I value accessibility and teaching—this portfolio is designed so others can fork, customize, and learn from it.
...
- Shipping real projects (PowerCat is in users' hands—that's the goal)
- Building architecture that scales and teaches (BTAR-R refactor → HyperFix.nvim polishing)
- Documenting my work to highlight problem-solving, not just code
- Creating templates and tools that lower barriers to entry in tech
